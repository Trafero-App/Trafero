...
async def main():
    ...
    await db.execute("""INSERT INTO passenger 
                    ...
                    INSERT INTO route (file_name, route_name, description, working_hours, active_days, capacity, company_name, expected_price) VALUES 
                     ...
                     ('van_10_1.geojson', 'Van 10 (Dawra - Matar)', 'Dawra - Port - Bechara el Khoury - Horsh beirut - Borj al Barajne - Tohwitet el Ghadir - Airport', '5:00 AM - 11:00 PM', 'Monday -> Sunday', '10 seats', 'Individual operators', '50.000 LL'), 
                     ('van_10_2.geojson', 'Van 10 (Matar - Dawra)', 'Airport - Tohwitet el Ghadir - Borj al Barajne - Horsh Beirut - Bechara el Khoury - Port - Dawra', '5:00 AM - 11:00 PM', 'Monday -> Sunday', '10 seats', 'Individual operators', '50.000 LL'),
                    ...
                    (2, 563, 3, 0), (2, 563, 4, 4403), (2, 664, 13, 203), (2, 664, 14, 351), 
                    (2, 678, 7, 581), (2, 678, 8, 476), (2, 1549, 11, 420), (2, 1549, 12, 1025), 
                    (2, 1718, 9, 738), (2, 1718, 10, 1050), (2, 1947, 9, 981), (2, 1947, 10, 804),
                     

                    (3, 0, 1, 1421), (3, 0, 2, 563), (3, 0, 13, 308), (3, 0, 14, 248),
                    (3, 198, 7, 953), (3, 198, 8, 95), (3, 526, 11, 1280), (3, 526, 12, 149),
                     

                    (4, 3919, 11, 1280), (4, 3919, 12, 149), (4, 4219, 7, 953), (4, 4219, 8, 95),
                    (4, 4403, 1, 1421), (4, 4403, 2, 563), (4, 4403, 13, 308), (4, 4403, 14, 248),
                     

                    (5, 59, 13, 0), (5, 59, 14, 609), (5, 270, 11, 556), (5, 270, 12, 885),
                    (5, 331, 9, 317), (5, 331, 10, 1494), (5, 433, 1, 1546), (5, 433, 2, 440),
                    (5, 438, 13, 436), (5, 438, 14, 121), (5, 464, 11, 746), (5, 464, 12, 681), 
                      
                     
                    (6, 758, 11, 746), (6, 758, 12, 681), (6, 782, 13, 436), (6, 782, 14, 121),
                    (6, 787, 1, 1546), (6, 787, 2, 440), (6, 893, 9, 317), (6, 893, 10, 1494),
                    (6, 962, 11, 556), (6, 962, 12, 885), (6, 1262, 13, 0), (6, 1262, 14, 609),
                     

                    (7, 573, 13, 181), (7, 573, 14, 362), (7, 581, 1, 1306), (7, 581, 2, 678),
                    (7, 953, 3, 198), (7, 953, 4, 4219), (7, 1104, 11, 967), (7, 1104, 12, 462),
                     

                    (8, 0, 11, 967), (8, 0, 12, 462), (8, 95, 3, 198), (8, 95, 4, 4219),
                    (8, 476, 1, 1306), (8, 476, 2, 678), (8, 483, 13, 181), (8, 483, 14, 362),
                     

                    (9, 61, 13, 60), (9, 61, 14, 512), (9, 316, 11, 615), (9, 316, 12, 817),
                    (9, 317, 5, 331), (9, 317, 6, 893), (9, 738, 1, 264), (9, 738, 2, 1718),
                    (9, 738, 11, 266), (9, 738, 12, 1187), (9, 981, 1, 14), (9, 981, 2, 1947),
                     

                    (10, 804, 1, 14), (10, 804, 2, 1947), (10, 1050, 1, 264), (10, 1050, 2, 1718),
                    (10, 1052, 11, 266), (10, 1052, 12, 1187), (10, 1494, 5, 331), (10, 1494, 6, 893),
                    (10, 1495, 11, 615), (10, 1495, 12, 817), (10, 1750, 13, 60), (10, 1750, 14, 512),
                     

                    (11, 266, 9, 738), (11, 266, 10, 1052), (11, 420, 1, 429), (11, 420, 2, 1549),
                    (11, 556, 5, 270), (11, 556, 6, 962), (11, 615, 9, 316), (11, 615, 10, 1495),
                    (11, 721, 1, 1550), (11, 721, 2, 436), (11, 723, 13, 437), (11, 723, 14, 120), (11, 746, 5, 464),
                    (11, 746, 6, 758), (11, 967, 7, 1104), (11, 967, 8, 0), (11, 1280, 3, 526), (11, 1280, 4, 3919), 
                     

                    (12, 149, 3, 526), (12, 149, 4, 3919), (12, 462, 7, 1104), (12, 462, 8, 0),
                    (12, 681, 5, 464), (12, 681, 6, 758), (12, 707, 13, 437), (12, 707, 14, 120),
                    (12, 709, 1, 1550), (12, 709, 2, 436), (12, 817, 9, 316), (12, 817, 10, 1495), (12, 885, 5, 270),
                    (12, 885, 6, 962), (12, 1025, 1, 429), (12, 1025, 2, 1549), (12, 1187, 9, 738), (12, 1187, 10, 1052),
                     

                    (13, 0, 5, 59), (13, 0, 6, 1262), (13, 60, 9, 61), (13, 60, 10, 1750),
                    (13, 181, 7, 573), (13, 181, 8, 483), (13, 203, 1, 1319), (13, 203, 2, 664), (13, 308, 3, 0),
                    (13, 308, 4, 4403), (13, 436, 5, 438), (13, 436, 6, 782), (13, 437, 11, 723), (13, 437, 12, 707),
                     

                    (14, 120, 11, 723), (14, 120, 12, 707), (14, 121, 5, 438), (14, 121, 6, 782),
                    (14, 248, 3, 0), (14, 248, 4, 4403), (14, 351, 1, 1319), (14, 351, 2, 664), (14, 362, 7, 573),
                    (14, 362, 8, 483), (14, 512, 9, 61), (14, 512, 10, 1750), (14, 609, 5, 59), (14, 609, 6, 1262);
